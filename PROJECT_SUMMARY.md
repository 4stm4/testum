...
### 🔮 Планы развития:
- 🐳 **Управление нативными контейнерами** на удаленных хостах (без Docker)
- 🖥️ **Создание виртуальных машин** через libvirt + KVM + QEMU
...
### Medium Priority
- **Нативные контейнеры** - управление контейнерами без Docker
- **VM управление** - создание и управление виртуальными машинами через libvirt + KVM + QEMU
...
- 🔮 Создание и управление виртуальными машинами (libvirt + KVM + QEMU)
