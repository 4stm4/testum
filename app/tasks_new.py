...
# Регистрация executors в engine
engine.executors.append(DeployKeysExecutor())
engine.executors.append(RunCommandExecutor())
...
## executor будет реализован ниже
    ...
    # task_id будет получен из pyjobkit ExecContext
